...
# MAGIC %md
# MAGIC # DICOM MONAI Spleen Segmentation with Pixels and MLflow
# MAGIC
# MAGIC This notebook validates the spleen DICOM-first MONAI bundle workflow:
# MAGIC read a DICOM series from a Unity Catalog Volume, generate a MONAI Deploy
# MAGIC application from `MONAI/spleen_ct_segmentation`, log it as an MLflow
