...
# MAGIC
# MAGIC This notebook validates a DICOM-first MONAI bundle workflow:
# MAGIC read a DICOM series from a Unity Catalog Volume, generate a MONAI Deploy
# MAGIC application from a public MONAI bundle, log it as an MLflow pyfunc model,
# MAGIC and write DICOM outputs back to the Volume.
