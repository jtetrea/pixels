...
# MAGIC %md
# MAGIC # DICOM MONAI Pancreas Segmentation with Pixels and MLflow
# MAGIC
# MAGIC This notebook validates the pancreas DICOM-first MONAI bundle workflow:
# MAGIC read a DICOM series from a Unity Catalog Volume, generate a MONAI Deploy
# MAGIC application from `MONAI/pancreas_ct_dints_segmentation`, log it as an
# MAGIC MLflow pyfunc model, and write DICOM outputs back to the Volume.
...
PIXELS_MONAI_MODEL_ID = "MONAI/pancreas_ct_dints_segmentation"
